...
<%@page import="com.fc.entity.Types"%>
<%@ page import="com.fc.dao.TypesDao" %>
<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
<%@ page import="com.fc.service.TypesService" %>
<%@ page import="com.fc.impl.TypesServiceImpl" %>
<%@ page import="com.fc.controller.TypesController" %>
<html>
<head>
